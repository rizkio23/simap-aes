        ...
        <div class="col-lg-6 mb-5">
          <div class="card">
            <div class="card-header">
              <h3 class="h6 text-uppercase mb-0">Tambah Data Unit Kerja</h3>
            </div>
            <div class="card-body">
              <form method="post" action="<?php echo base_url().'index.php/master/unit_act/tambah' ?>">
                <input type='hidden' id='id' name="id" placeholder='ID' readonly="" required="" />
            ...
            <div class="card-body ">                          
              <table class="table table-striped table-sm card-text table-center">
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-sm btn-info" href="#modal-edit" data-toggle="modal" role="button" onclick="edit('<?php echo $u->ID_UNIT; ?>', '<?php echo $u->NAMA; ?>')">Edit</button>
                    <button class="btn btn-sm btn-danger" href="<?php echo base_url().'index.php/master/unit_act/hapus-'.$u->ID_UNIT; ?>" onclick="return confirm('Anda yakin?');">Hapus</button>
                  </td>
                </tr>
                <?php $no++; } ?>
                </tbody>
  ...
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role='form' action='<?php echo base_url()."index.php/master/unit_act/ubah"; ?>' method='post'>
