      ...
      <div class="row">
        ...
        <div class="card">
          <div class="card-header">
            <h6 class="text-uppercase mb-0">Form Surat Masuk</h6>
            </div>
            <div class="card-body ">        
            <?php if (!empty($alert)){ ?>
            ...
            <?php } elseif (!empty($success)) { ?>
              ...
              <div class="row">
                <div class="col-md-6">
                  <input type='text' id='id' name="id" placeholder='ID Surat' value="<?php echo $id; ?>" required="" readonly="" />
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type='password' name="pass" placeholder='16 Digit' class='form-control' required=""/>
    						  </div>
                  <div class="form-group">
