        ...
        <div class="col-lg-12 mb-5">
          <div class="card">
            <div class="card-header">
              <h6 class="text-uppercase mb-0">Daftar Arsip Keluar</h6>
              </div>
              <div class="card-body ">                          
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo base_url().'index.php/surat/keluar_detil/'.$s->ID_SURAT; ?>">
                        <button class="btn btn-sm btn-info" href="">DETIL</button>
                      </a>
                      <a href="<?php echo base_url().'index.php/surat/keluar_ubah/'.$s->ID_SURAT; ?>">
                        <button class="btn btn-sm btn-success">UBAH</button>
                      </a>
                      <a href="<?php echo base_url().'index.php/surat/keluar_hapus/'.$s->ID_SURAT; ?>">
