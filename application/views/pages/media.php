        ...
        <div class="col-lg-4 mb-5">
          <div class="card">
            <div class="card-header">
              <h3 class="h6 text-uppercase mb-0">Tambah Data Media</h3>
            </div>
            <div class="card-body">
              <form method="post" action="<?php echo base_url().'index.php/master/media_act/tambah' ?>">
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-sm btn-info" href="#modal-edit" data-toggle="modal"
                        onclick="edit('<?php echo $m->ID_MEDIA; ?>', '<?php echo $m->NAMA; ?>')">EDIT</button>
                    <button class="btn btn-sm btn-danger" href="<?php echo base_url().'index.php/master/jenis_act/hapus-'.$m->ID_MEDIA; ?>"
  ...
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role='form' action='<?php echo base_url()."index.php/master/media_act/ubah"; ?>' method='post'>
