  ...
  <div class="container-fluid px-xl-5">
    ...
    <section class="py-5">
      <div class="row">
        <div class="col-lg-4 mb-5">
          <div class="card">
            <div class="card-header">
              <h3 class="h6 text-uppercase mb-0">Tambah Data Jenis Surat</h3>
            </div>
            <div class="card-body">
              <form method="post" action="<?php echo base_url().'index.php/master/jenis_act/tambah' ?>">
        ...
        <div class="card">
          <div class="card-header">
            <h6 class="text-uppercase mb-0">Daftar Jenis Surat</h6>
            </div>
            <div class="card-body ">                          
                ...
                <tr>
                  ...
                  <td>
                    <button class="btn btn-sm btn-info" href="#modal-edit" data-toggle="modal"
                        onclick="edit('<?php echo $j->ID_JENIS; ?>', '<?php echo $j->NAMA; ?>')">EDIT</button>
                    <button class="btn btn-sm btn-danger" href="<?php echo base_url().'index.php/master/jenis_act/hapus-'.$j->ID_JENIS; ?>"
  ...
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 id="exampleModalLabel" class="modal-title">Edit Jenis Surat</h4>
        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
      </div>
      <div class="modal-body">
        <form role='form' action='<?php echo base_url()."index.php/master/jenis_act/ubah"; ?>' method='post'>
